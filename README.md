...
| [**evade-nids**](https://github.com/SohanBag/evade-nids) | Leakage-free intrusion-detection benchmarking. On real CTU-13 captures a random split reports 0.999 F1 where holding out whole capture sessions gives 0.169. Adversarial attacks are constrained to be physically sendable; unconstrained ones overstate evasion by **36 points**. |
